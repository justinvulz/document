...
#proof[
  ...
  我們只證明了$(a b)b^(-1) a^(-1) =e$，但是我們也需要證明$b^(-1) a^(-1)(a b) =e$也是成立的。
]
...
#exercise[
  在旋轉的對稱性下，用$n$個顏色對一個正四面體的*面*上色，總共有多少種不同的著色方式？
]

#exercise[
  一個九宮格的棋盤，我們要用$n$個不同的顏色對這個棋盤進行著色，可以通過旋轉，鏡射變換得到視為相同的著色方式。總共有多少種不同的著色方式？
